// @ts-ignore
import nodeFetch from '@skorpland/node-fetch'
    ...
    >
{
   ...
   *
   * {@link https://github.com/skorpland/powerbase-js/issues/92}
   */
  ...
  >(
    ...
    // https://github.com/skorpland/postgrest-js/pull/247
    ...
    let res = _fetch(this.url.toString(), {
      ...
      if (res.ok) {
        ...
        // Temporary partial fix for https://github.com/skorpland/postgrest-js/issues/361
        ...
        try {
          ...
          // Workaround for https://github.com/skorpland/postgrest-js/issues/295
   ...
   * const query = powerbase
   *   .from('users')
   *   .select()
   *   .overrideTypes<{ custom_field: string }>()
   *
   * // Replace existing types completely
   * const replaceQuery = powerbase
   *   .from('users')
   *   .select()
