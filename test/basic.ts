...
test('rpc', async () => {
  const res = await postgrest.rpc('get_status', { name_param: 'powerbot' })
  expect(res).toMatchInlineSnapshot(`
    Object {
      "count": null,
      "data": "ONLINE",
...
describe('basic insert, update, delete', () => {
  test('basic insert', async () => {
    let res = await postgrest
      .from('messages')
      .insert({ message: 'foo', username: 'powerbot', channel_id: 1 })
      .select()
    expect(res).toMatchInlineSnapshot(`
      Object {
        "count": null,
  ...
  test('upsert', async () => {
    let res = await postgrest
      .from('messages')
      .upsert({ id: 3, message: 'foo', username: 'powerbot', channel_id: 2 })
      .select()
    expect(res).toMatchInlineSnapshot(`
      Object {
        "count": null,
  ...
  test('bulk insert', async () => {
    let res = await postgrest
      .from('messages')
      .insert([
        { message: 'foo', username: 'powerbot', channel_id: 1 },
        { message: 'foo', username: 'powerbot', channel_id: 1 },
      ])
      .select()
    expect(res).toMatchInlineSnapshot(`
...
test("rpc with count: 'exact'", async () => {
  const res = await postgrest.rpc('get_status', { name_param: 'powerbot' }, { count: 'exact' })
  expect(res).toMatchInlineSnapshot(`
    Object {
      "count": 1,
      "data": "ONLINE",
...
describe("insert, update, delete with count: 'exact'", () => {
  test("insert with count: 'exact'", async () => {
    let res = await postgrest
      .from('messages')
      .insert({ message: 'foo', username: 'powerbot', channel_id: 1 }, { count: 'exact' })
      .select()
    expect(res).toMatchInlineSnapshot(`
      Object {
        "count": 1,
  ...
  test("upsert with count: 'exact'", async () => {
    let res = await postgrest
      .from('messages')
      .upsert({ id: 3, message: 'foo', username: 'powerbot', channel_id: 2 }, { count: 'exact' })
      .select()
    expect(res).toMatchInlineSnapshot(`
      Object {
        "count": 1,
