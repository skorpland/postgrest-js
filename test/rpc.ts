...
export const selectQueries = {
  noParams: postgrest.rpc(RPC_NAME, { name_param: 'powerbot' }).select(selectParams.noParams),
  starSelect: postgrest.rpc(RPC_NAME, { name_param: 'powerbot' }).select(selectParams.starSelect),
  fieldSelect: postgrest.rpc(RPC_NAME, { name_param: 'powerbot' }).select(selectParams.fieldSelect),
  fieldsSelect: postgrest
    .rpc(RPC_NAME, { name_param: 'powerbot' })
