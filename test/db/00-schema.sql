...
CREATE PUBLICATION powerbase_realtime FOR ALL TABLES;
...
ALTER TABLE public.users REPLICA IDENTITY FULL; -- Send "previous data" to powerbase
...
ALTER TABLE public.messages REPLICA IDENTITY FULL; -- Send "previous data" to powerbase
